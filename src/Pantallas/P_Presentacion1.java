...
public class P_Presentacion1 extends javax.swing.JFrame {
    ...
    public P_Presentacion1(Entrevista entrevista,int perfil, P_IniciarEntrevista padre) throws SQLException {
        initComponents();
//        this.setAlwaysOnTop(true);
                    ...
                    for(int x=0;x<tamaño_lista;x++){
                        ...
                        if(componente.isSelected()==true){
                            try {
                                ...
                                Logger.getLogger(P_Presentacion1.class.getName()).log(Level.SEVERE, null, ex);
                            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(b_rotar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 530, 100, 40));
        ...
        getContentPane().add(b_siguiente, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 530, 100, 40));
        ...
        getContentPane().add(b_finalizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 590, 100, 40));
        ...
        getContentPane().add(panel_respuestas, new org.netbeans.lib.awtextra.AbsoluteConstraints(346, 529, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P_Presentacion1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    int id_perfil = 0;
                    new P_Presentacion1(entre,id_perfil, pantalla).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(P_Presentacion1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
