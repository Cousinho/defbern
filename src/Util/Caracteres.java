...
public class Caracteres extends PlainDocument
{
   private JTextField editor;
    
   private int numeroMaximoCaracteres;

    public Caracteres(JTextField editor, int numeroMaximoCaracteres)
    {
        this.editor=editor;
    ...
    public void insertString(int arg0, String arg1, AttributeSet arg2) throws BadLocationException
    {
       ...
       for (int i=0;i<arg1.length();i++){
           if((!Character.isLetter(arg1.charAt(i)))&&(!Character.isSpace(arg1.charAt(i)))){
             return;   
           }
